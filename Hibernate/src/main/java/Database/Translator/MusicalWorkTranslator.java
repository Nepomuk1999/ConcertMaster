...
public class MusicalWorkTranslator {
    ...
    public static MusicalWorkEntity transformMusicalWorkToEntity(MusicalWorkDomainInterface e, DatabaseFacade facade) {
        ...
        mwe.setInstrumentationByInstrumentationId(InstrumentationTranslator.transformInstrumentationToEntity(e.getInstrumentation(), facade));
    ...
    public static MusicalWorkDomainInterface transformMusicalWorkToInterface(MusicalWorkEntity musicalWork, DatabaseFacade facade) {
        ...
        musicalWorkDomainObject.setInstrumentation(InstrumentationTranslator.transformInstrumentationToInterface(musicalWork.getInstrumentationByInstrumentationId(), facade));
