 ...
 * @author Julian
 */
public class TourEventDomain extends EventDomain implements EventDomainInterface, EventViewInterface {
    ...
    public TourEventDomain() {
        super(EventType.Tour);
    }
    ...
    @Override
    public void setMusicalWorks(List<MusicalWorkDomainInterface> musicalWorks) {
    ...
    public void validate() throws DateException, RequiredFieldMissingException {
        ...
        if (super.getStartDate().isEqual(super.getEndDate())) {
            throw new DateException("The start- and end-date have to be a different day!");
        }
    }
