 ...
 * @author Julian
 */
public class RehearsalEventDomain extends EventDomain implements EventDomainInterface, EventViewInterface {
    private EventDomainInterface rehearsalFor;
    private InstrumentationDomainInterface generalInstrumentation;
    private String description;
    private List<DutyViewInterface> duties;


    public RehearsalEventDomain() {
        super(EventType.Rehearsal);
    }
    ...
    public List<MusicalWorkViewInterface> getMusicalWorks() {
        return rehearsalFor.getMusicalWorks();
    }
    ...
    @Override
    public void setRehearsalFor(EventDomainInterface rehearsalFor) {
    ...
    public void validate() throws DateException, RequiredFieldMissingException {
        super.validate();
        if (!getStartDate().isEqual(getEndDate())) {
    ...
    public InstrumentationViewInterface getGeneralInstrumentation() {
        ...
        if(generalInstrumentation == null){
            return rehearsalFor.getGeneralInstrumentation();
        }
