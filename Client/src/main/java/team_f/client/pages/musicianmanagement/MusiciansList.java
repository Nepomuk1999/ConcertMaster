...
public class MusiciansList extends BaseTablePage<Person, Person, Person, PersonParameter> {
    ...
    public void initialize() {
        ...
        gridPane.add(new Label("Address:"), 0, 9);
        gridPane.add(new Label("Email:"), 0, 11);
        gridPane.add(new Label("Person Role:"), 0, 13);
        gridPane.add(new Label("Account Role:"), 0, 15);
        gridPane.add(new Label("Section:"), 0, 17);
        gridPane.add(new Label("Instruments:"), 0, 19);
        gridPane.add(new Label("Initials:"), 0, 21);
        gridPane.add(new Label("Gender:"), 0, 23);
        gridPane.add(_firstname, 1, 1);
        gridPane.add(_lastname, 1, 3);
        gridPane.add(_username, 1, 5);
        gridPane.add(_phonenumber, 1, 7);
        gridPane.add(_address, 1, 9);
        gridPane.add(_email, 1, 11);
        gridPane.add(_personrole, 1, 13);
        gridPane.add(_accountrole, 1, 15);
        gridPane.add(_section, 1, 17);
        gridPane.add(_instruments, 1, 19);
        gridPane.add(_initials, 1, 21);
        gridPane.add(_gender, 1, 23);
