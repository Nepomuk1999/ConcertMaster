 ...
 * @author Julian
 */
public class HofkapelleEventDomain extends EventDomain implements EventDomainInterface, EventViewInterface {
    ...
    public HofkapelleEventDomain() {
        super(EventType.Hofkapelle);
    }
