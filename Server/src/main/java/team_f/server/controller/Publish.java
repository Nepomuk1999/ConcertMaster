...
import team_f.jsonconnector.entities.special.request.PublishRequest;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(contentType != null && contentType.startsWith(MediaType.APPLICATION_JSON)) {
            ...
            if(request != null) {
                ...
                team_f.jsonconnector.entities.Publish publish = request;
                ...
                if(publish != null) {
                    ...
                    errorList = JsonResponse.prepareErrorMessages(resultErrorList);
                }
